...
<br>
<h1 align="center">
  ⭐ React Native Dropdown Search List </h1>

<div align="center">

React Native Select List Equivalent to Html's Select 2"
...
```sh
$ npm install react-native-dropdown-search-list
...
```sh
$ yarn add react-native-dropdown-search-list
```
...
```jsx
import { MultipleSelectList } from 'react-native-dropdown-search-list'
